    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <?php foreach ($kapster as $k) { ?>
                <form action="<?= base_url('transaksi/ubahkapster'); ?>" method="post">
                    <div class="form-group">
                        <input type="hidden" name="id" id="id" value="<?php echo $k['id']; ?>">
                        <input type="text" class="form-control form-control-user" id="kapster" name="kapster" placeholder="Masukkan Kapster" value="<?= $k['kapster']; ?>">
                    </div>
                    <div class="form-group">
