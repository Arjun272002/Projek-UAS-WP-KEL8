    ...
    <div class="row">
        <div class="col-lg-6">
            <?php if (validation_errors()) {
                ...
                redirect('transaksi/ubahkategori/' . $k['id']);
            } ?>
            <?php foreach ($kategori as $k) { ?>
                <form action="<?= base_url('transaksi/ubahKategori'); ?>" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" name="harga" id="harga" placeholder="Masukan No Telpon" value="<?= $k['harga']; ?>">
                    </div>
                    <div class="form-group">
