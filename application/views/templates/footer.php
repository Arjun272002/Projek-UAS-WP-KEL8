...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span> <strong>Copyright &copy;</strong> Projek UAS | Barbershop BB'ON <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<script src="<?= base_url('assets/'); ?>js/rupiahid.js"></script>
<!-- Page level plugins -->
<script src="<?= base_url('assets/'); ?>vendor/datatables/jquery.dataTables.min.js"></script>
<script src="<?= base_url('assets/'); ?>vendor/ajax.php"></script>
